...
public class EnemyRanged : MonoBehaviour, EnemyController
{
    ...
    public float whenToLaunchBullet = 1.7f;
    ...
    public void Attack()
    {
        ...
        if(alreadyAttacked == false){
            ...
            // Attack code
            // play animation OR shoot projectile
            ...
            Invoke(nameof(LaunchBullet), whenToLaunchBullet);
    ...
    {   
        ...
        GameObject projectile = Instantiate(bullet, spawnPoint.position, Quaternion.identity) as GameObject; //Spawns the selected projectile
        projectile.transform.LookAt(aimDirection);
